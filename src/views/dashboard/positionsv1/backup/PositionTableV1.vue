<template>
 ...
 -->
        <span
          v-if="props.column.field === 'instrument'"
          :class="'text-dark'+' '+'font-weight-bolder'"
        >
      ...
      >
        ...
        <span
          ...
          :class="((props.row.quantity) != 0) ? 'font-weight-normal':'text-muted'"
        >
          {{ props.row.instrument }}
        </span>
        ...
        <span
          ...
          :class="((props.row.quantity) != 0) ? pnlVariant(props.row.pnl)+' '+'font-weight-normal':'text-muted'"
        >
        ...
        <span
          v-else-if="props.column.field === 'mtm'"
          :class="((props.row.quantity) != 0) ? mtmVariant(props.row.mtm)+' '+'font-weight-normal':'text-muted'"
        >
        ...
        <span
          v-else-if="props.column.field === 'quantity'"
          :class="((props.row.quantity) != 0) ? qtyVariant(props.row.quantity)+' '+'font-weight-normal':'text-muted'"
        >
