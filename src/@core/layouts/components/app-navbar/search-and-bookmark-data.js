...
export default {
  pages: {
    key: 'title',
    data: [
      { title: 'Positions', route: { name: 'dashboard-positions' }, icon: 'ServerIcon', isBookmarked: true },
      { title: 'Positions-V1', route: { name: 'dashboard-positionsv1' }, icon: 'ServerIcon', isBookmarked: true },
      { title: 'MTM P&L Triggers', route: { name: 'dashboard-mtmpnltriggers' }, icon: 'ZapIcon', isBookmarked: true },
      { title: 'Capital Percentage', route: { name: 'dashboard-squareoff' }, icon: 'AlertTriangleIcon', isBookmarked: true },
      { title: 'Date & Time', route: { name: 'dashboard-dateandtime' }, icon: 'CalendarIcon', isBookmarked: true },
      { title: 'API Credentials', route: { name: 'dashboard-api' }, icon: 'KeyIcon', isBookmarked: true },
      { title: 'Power Kill', route: { name: 'dashboard-powerkill' }, icon: 'XSquareIcon', isBookmarked: true },
    ],
  },
  files: {
    key: 'file_name',
